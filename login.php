...
$web=new web;
session_start();
if(isset($_POST["user_id"]) && isset($_POST["user_p"])){
    $user_id=$_POST["user_id"];
    $user_p=$_POST["user_p"];
    if($web->adminLogin($user_id, $user_p)){
        $_SESSION["type"]="user";
        $_SESSION["user_id"]=$web->userLogin($user_id,$user_p);
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form action="login.php" method="post">
                ...
                <input type="text" id="login" class="fadeIn second" name="user_id" placeholder="帳號" required>
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="signup.php">註冊</a>
            </div>
