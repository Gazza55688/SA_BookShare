...
if(isset($type)){
    echo "<li><a class='active'>$record[1]，你好</a></li><li><a href='index.php'>首頁</a></li><li><a href='books.php'>查看現有書籍</a></li><li><li><a href='my.php'>我的書籍</a></li><li><a href='manage.php'>管理訂單</a><li></li><li><a href='order.php'>我的訂單</a><li><a href='index.php?status=logout'>登出</a></li>";
}
else{
