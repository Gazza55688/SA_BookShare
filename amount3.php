...
<head>
    ...
    <script type="text/javascript">
        ...
        var t10 = <?php echo $tot10;?>;
        var t11 = <?php echo $tot11;?>;
        var t12 = <?php echo $tot12;?>;
        var t1 = <?php echo $tot1;?>;
                                    ...
                                    <form action="reserve2.php" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style=";margin-left:250px;">
                                                <div id="columnchart_material" style="width: 600px; height: 500px;border:1px solid black"></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
