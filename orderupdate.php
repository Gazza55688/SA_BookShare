...
if(isset($_GET["updateid"])){
    $re=$web->recordOrder($_GET["updateid"]);
    $row=mysqli_fetch_row($re);
}
if(isset($_POST["start"]) && isset($_POST["end"]) && isset($_POST["announce"]) && isset($_POST["updateid"]) && isset($_POST["roomid"])){
    $date=date("Y-m-d");
    if($web->timeCheck($date,$_POST["start"],$_POST["end"])){
        if($web->orderUpdate($_POST["start"],$_POST["end"],$_POST["announce"],$_POST["updateid"],$_POST["roomid"])){
            echo "<script> {window.alert('修改成功');location.href='order.php'} </script>";
        }
    }
    else{
        echo "<script> {window.alert('時間選取錯誤');location.href='order.php'} </script>";
    }
}
?>
<!DOCTYPE html>
    ...
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
                    ...
                    <div class="container">
                        <div class="nav-header">
                            ...
                            if(isset($type)){
                                ...
                                if($type=="manager"){
                                    echo "<li><a href='index.php'>主頁</a></li><li><a href='announce.php'>公告區</a></li><li><a href='amount.php'>營運報表</a></li><li><a href='order.php' class='active'>後台管理</a></li><li><a href='index.php?status=logout'>登出</a></li>";
                                }
            ...
            <div id="featured-hotel" class="fh5co-bg-color" style="background-color:white">
                <div class="container">
                    <a href='order.php' class='btn btn-primary btn-luxe-primary'>回上一頁<i class='ti-angle-right'></i></a>
                    <div class="row">
                        <div class="col-md-12">
                ...
                echo "<div class='feature-full-2col'>
					<div class='f-hotel' style='border:1px black solid'>
						...
						<div class='desc'>
                        <input type='hidden' name='roomid' value='$row[5]'>
							入住日期：<input type='date' name='start' value='$row[3]' style='height:30px;color:black'><br><br>
                            退房日期：<input type='date' name='end' value='$row[4]' style='height:30px;color:black'><br><br>
                            使用優惠：<select name='announce'>";
                            $res=$web->announce();
