...
if(isset($_POST["name"]) && isset($_POST["word"]) && isset($_POST["start"]) && isset($_POST["end"]) && isset($_POST["percent"]) && isset($_POST["updateid"])){
    if($web->announceUpdate($_POST["updateid"],$_POST["name"],$_POST["word"],$_POST["start"],$_POST["end"],$_POST["percent"])){
        echo "<script> {window.alert('修改成功');location.href='new.php'} </script>";
    }
}
?>
<!DOCTYPE html>
    ...
    <div id="fh5co-wrapper">
        <div id="fh5co-page">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
                            <div class="fh5co-intro fh5co-table-cell">
                                <h1 class="text-center">修改使用者資訊</h1>
            ...
            <div id="featured-hotel" class="fh5co-bg-color" style="background-color:white">
                <div class="container">
                    <a href='new.php' class='btn btn-primary btn-luxe-primary'>回上一頁<i class='ti-angle-right'></i></a>
                    <div class="row">
                        <div class="col-md-12">
                ...
                echo "
					<div class='feature-full-2col'>
						...
						<div class='desc'>
							姓名：<input type='text' name='name' value='$row[1]' style='height:30px;color:black'><br>
							學號：<input type='text' name='name' value='$row[2]' style='height:30px;color:black'><br>
                            密碼：<input type='text' name='name' value='$row[3]' style='height:30px;color:black'><br><br>
