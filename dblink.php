<?php
    ...
    @$name=$record[0];
    if($method=="insert"){
            @$sql="insert into book (own_name, book_name, book_athor, book_ver, book_pic, buy_b, s_price) values ('$name','$book_name','$book_athor','$book_ver','$book_pic','$status','$s_price')";
